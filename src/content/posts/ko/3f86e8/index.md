...
- 양자 컴퓨팅의 이해를 돕는 다섯 가지 핵심 아이디어
  ![양자 컴퓨팅 다섯가지 핵심 개념](./ideas.svg)
...
- 양자 기술 발전에 전환점을 나타내는 기술들, 양자 기술 1.0
  ![양자 기술 1.0 이정표.svg](./timeline.svg)
  - 태양 전지 1890
    - 1905년 양자 역학의 산물로 아인슈타인이 광전 효과를 설명함
    - 양자 컴퓨팅에 직접 사용되진 않음
    - 태양 전지의 효율은 2006년에 40%의 효율을 달성. 2024년 최고 기록은 47.6%
      ![태양광 발전 효율 연표](./solar-panel-best-efficiency.png)
...
- 1968년 스티븐 위스너의 양자 화폐 연구
  ...
  - ![반바지님의 양자 암호화폐를 주제로 한 단편 만화](./bahnbazi.png)
...
![그림으로 이해하는 양자컴퓨터의 구조 책과 그림으로 배우는 양자 컴퓨터 책](./another-books.jpeg)
